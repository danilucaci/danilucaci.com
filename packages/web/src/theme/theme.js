...
export const theme = {
  ...
  font: {
    family: {
      display: {
        fallback:
          "system-ui, BlinkMacSystemFont, -apple-system, 'Segoe UI', Georgia, 'Times New Roman', Times, serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'",
        regular:
          "WorkSans, system-ui, BlinkMacSystemFont, -apple-system, 'Segoe UI', Georgia, 'Times New Roman', Times, serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'",
        medium:
          "WorkSansMedium, system-ui, BlinkMacSystemFont, -apple-system, 'Segoe UI', Georgia, 'Times New Roman', Times, serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'",
        bold: "WorkSansBold, system-ui, BlinkMacSystemFont, -apple-system, 'Segoe UI', Georgia, 'Times New Roman', Times, serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'",
      },
      body: {
        fallback:
        ...
        bold: "LatoBold, system-ui, BlinkMacSystemFont, -apple-system, 'Segoe UI', Roboto, Oxygen-Sans, Ubuntu, Cantarell, 'Helvetica Neue', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'",
        italic:
          "LatoItalic, system-ui, BlinkMacSystemFont, -apple-system, 'Segoe UI', Roboto, Oxygen-Sans, Ubuntu, Cantarell, 'Helvetica Neue', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'",
      },
      code: {
        fallback:
          "'Ubuntu Mono', Consolas, Menlo, 'Liberation Mono', Courier, monospace",
        regular:
          "RobotoMono, 'Ubuntu Mono', Consolas, Menlo, 'Liberation Mono', Courier, monospace",
        italic:
          "RobotoMonoItalic, 'Ubuntu Mono', Consolas, Menlo, 'Liberation Mono', Courier, monospace",
      },
    },
    size: {
      display: {
        desktop: {
          ...
          h4: "1.25rem",
          h5: "1.125rem",
          contactCardTitle: "3rem",
          contactCardSubtitle: "1.5rem",
          subtitle: "1.25rem",
          articleTitle: "2rem",
        ...
        mobile: {
          ...
          h4: "1.25rem",
          h5: "1.125rem",
          contactCardTitle: "1.75rem",
          contactCardSubtitle: "1.125rem",
          subtitle: "1.125rem",
          articleTitle: "1.5rem",
    ...
    lineHeight: {
      display: {
        desktop: {
          ...
          h4: "2rem",
          h5: "2rem",
          contactCardTitle: "3.5rem",
          contactCardSubtitle: "2.25rem",
          subtitle: "2rem",
          articleTitle: "2.5rem",
        ...
        mobile: {
          ...
          h4: "2rem",
          h5: "2rem",
          contactCardTitle: "2.25rem",
          contactCardSubtitle: "2rem",
          subtitle: "2rem",
          articleTitle: "2rem",
